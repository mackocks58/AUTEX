              ...
              <div className="field">
                ...
                <div style={{ position: "relative" }}>
                  <input
                    ...
                    minLength={6}
                    style={{ background: "rgba(0,0,0,0.3)", borderColor: "rgba(250, 204, 21, 0.2)", paddingRight: 40 }}
                    required
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    style={{ position: "absolute", right: 12, top: 0, bottom: 0, display: "flex", alignItems: "center", background: "none", border: "none", color: "var(--muted)", cursor: "pointer", padding: 0 }}
                  >
                    {showPassword ? (
